...
#define OUTPUT(arg, s, l)                                                 \
	...
	int longFlag = 0; //1 means true
	int negFlag = 0;  // 1 means negative but we don't care?
	int width = 0;	  //it's a number
	int prec;		  //number too
	int ladjust;	  // left adjust, 1 is true
	char padc = '0';  // character used to fill the blank and don't need to be initialize?
